...
**8. Оплата по карте с именем владельца карты в поле «Владелец» на кирилица:**
...
**9. Оплата по карте с указанием невалидного формата поля CVC/CVV:**
...
**10. Оплата по карте нулевым CVC/CVV:**
