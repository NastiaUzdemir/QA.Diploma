...
Само приложение расположено в файле [`aqa-shop.jar`](../../Desktop/qa.diploma/aqa-shop.jar) и запускается стандартным способом `java -jar aqa-shop.jar` на порту 8080.

В файле [`application.properties`](../../Desktop/qa.diploma/application.properties) приведён ряд типовых настроек:
...
Учётные данные и URL для подключения задаются в файле [`application.properties`](../../Desktop/qa.diploma/application.properties).
